...
# Forward Kinematics
    ...
    AF110 = C10*(AF19+BEF39*s.dpt[3,5])-S10*(AF38+BS99*s.dpt[3,5])
    AF210 = AF29+BEF69*s.dpt[3,5]
    AF310 = C10*(AF38+BS99*s.dpt[3,5])+S10*(AF19+BEF39*s.dpt[3,5])
    ...
    AM110_4 = -AM38_4*S10+C10*(AM19_4+OB29_4*s.dpt[3,5])
    AM210_4 = AM29_4-OB19_4*s.dpt[3,5]
    AM310_4 = AM38_4*C10+S10*(AM19_4+OB29_4*s.dpt[3,5])
    OB110_5 = OB19_5*C10-S6p8*S10
    OB310_5 = OB19_5*S10+S6p8*C10
    AM110_5 = C10*(AM19_5+OB29_5*s.dpt[3,5])
    AM210_5 = AM29_5-OB19_5*s.dpt[3,5]
    AM310_5 = S10*(AM19_5+OB29_5*s.dpt[3,5])
    OB110_6 = C10*S9
    OB310_6 = S10*S9
    AM110_6 = -AM38_6*S10+C10*(AM19_6+s.dpt[3,5]*C9)
    AM210_6 = AM29_6-s.dpt[3,5]*S9
    AM310_6 = AM38_6*C10+S10*(AM19_6+s.dpt[3,5]*C9)
    OB110_8 = C10*S9
    OB310_8 = S10*S9
    AM110_8 = s.dpt[3,5]*C10*C9
    AM210_8 = -s.dpt[3,5]*S9
    AM310_8 = s.dpt[3,5]*S10*C9
...
# Backward Dynamics
    ...
    CF19 = -s.trq[1,9]+CF110*C10+CF310*S10-FA210*s.dpt[3,5]
    CF29 = -s.trq[2,9]+CF210+s.dpt[3,5]*(FA110*C10+FA310*S10)
    CF39 = -s.trq[3,9]-CF110*S10+CF310*C10
    FM19_1 = FB110_1*C10+FB310_1*S10
    FM39_1 = -FB110_1*S10+FB310_1*C10
    CM19_1 = -FB210_1*s.dpt[3,5]
    CM29_1 = s.dpt[3,5]*(FB110_1*C10+FB310_1*S10)
    FM19_2 = FB110_2*C10+FB310_2*S10
    FM39_2 = -FB110_2*S10+FB310_2*C10
    CM19_2 = -FB210_2*s.dpt[3,5]
    CM29_2 = s.dpt[3,5]*(FB110_2*C10+FB310_2*S10)
    FM19_3 = FB110_3*C10+FB310_3*S10
    FM39_3 = -FB110_3*S10+FB310_3*C10
    CM19_3 = -FB210_3*s.dpt[3,5]
    CM29_3 = s.dpt[3,5]*(FB110_3*C10+FB310_3*S10)
    FM19_4 = FB110_4*C10+FB310_4*S10
    FM39_4 = -FB110_4*S10+FB310_4*C10
    CM19_4 = CM110_4*C10+CM310_4*S10-FB210_4*s.dpt[3,5]
    CM29_4 = CM210_4+s.dpt[3,5]*(FB110_4*C10+FB310_4*S10)
    CM39_4 = -CM110_4*S10+CM310_4*C10
    FM19_5 = FB110_5*C10+FB310_5*S10
    FM39_5 = -FB110_5*S10+FB310_5*C10
    CM19_5 = CM110_5*C10+CM310_5*S10-FB210_5*s.dpt[3,5]
    CM29_5 = CM210_5+s.dpt[3,5]*(FB110_5*C10+FB310_5*S10)
    CM39_5 = -CM110_5*S10+CM310_5*C10
    FM19_6 = FB110_6*C10+FB310_6*S10
    FM39_6 = -FB110_6*S10+FB310_6*C10
    CM19_6 = CM110_6*C10+CM310_6*S10-FB210_6*s.dpt[3,5]
    CM29_6 = CM210_6+s.dpt[3,5]*(FB110_6*C10+FB310_6*S10)
    CM39_6 = -CM110_6*S10+CM310_6*C10
    CM19_8 = CM110_8*C10+CM310_8*S10-FB210_8*s.dpt[3,5]
    CM29_8 = CM210_8+s.dpt[3,5]*(FB110_8*C10+FB310_8*S10)
    ...
    CF26 = -s.trq[2,6]+CF27+CF28+s.In[1,6]*OM16*OM36+s.In[5,6]*OA25-s.In[9,6]*OM16*OM36+FA16*s.l[3,6]-s.dpt[1,2]*(-FA17*S7+FA37*C7)-s.dpt[1,3]*(-FF18*S8+FF39*C8)+s.dpt[3,3]*(FF18*C8+FF39*S8)
    CF36 = -s.trq[3,6]-s.In[1,6]*OM16*OM26+s.In[5,6]*OM16*OM26+s.In[9,6]*OA36-CF17*S7-CF18*S8+CF37*C7+CF39*C8+FA27*s.dpt[1,2]+FF28*s.dpt[1,3]
    FB16_1 = s.m[6]*AM16_1
    FB26_1 = s.m[6]*AM25_1
    FB36_1 = s.m[6]*AM36_1
    ...
    CM26_1 = CM28_1+FB16_1*s.l[3,6]-s.dpt[1,2]*(-FB17_1*S7+FB37_1*C7)-s.dpt[1,3]*(-FM18_1*S8+FM39_1*C8)+s.dpt[3,3]*(FM18_1*C8+FM39_1*S8)
    CM36_1 = -CM18_1*S8+FB27_1*s.dpt[1,2]+FM28_1*s.dpt[1,3]
    FB16_2 = s.m[6]*AM16_2
    FB26_2 = s.m[6]*AM25_2
    FB36_2 = s.m[6]*AM36_2
    ...
    CM26_2 = CM28_2+FB16_2*s.l[3,6]-s.dpt[1,2]*(-FB17_2*S7+FB37_2*C7)-s.dpt[1,3]*(-FM18_2*S8+FM39_2*C8)+s.dpt[3,3]*(FM18_2*C8+FM39_2*S8)
    CM36_2 = -CM18_2*S8+FB27_2*s.dpt[1,2]+FM28_2*s.dpt[1,3]
    FB16_3 = s.m[6]*AM16_3
    FB26_3 = s.m[6]*S5
    FB36_3 = s.m[6]*AM36_3
    ...
    CM26_3 = CM28_3+FB16_3*s.l[3,6]-s.dpt[1,2]*(-FB17_3*S7+FB37_3*C7)-s.dpt[1,3]*(-FM18_3*S8+FM39_3*C8)+s.dpt[3,3]*(FM18_3*C8+FM39_3*S8)
    CM36_3 = -CM18_3*S8+FB27_3*s.dpt[1,2]+FM28_3*s.dpt[1,3]
    ...
    CM26_4 = CM27_4+CM28_4+s.In[5,6]*S5+FB16_4*s.l[3,6]-s.dpt[1,2]*(-FB17_4*S7+FB37_4*C7)-s.dpt[1,3]*(-FM18_4*S8+FM39_4*C8)+s.dpt[3,3]*(FM18_4*C8+FM39_4*S8)
    CM36_4 = s.In[9,6]*OB36_4-CM17_4*S7-CM18_4*S8+CM37_4*C7+CM39_4*C8+FB27_4*s.dpt[1,2]+FM28_4*s.dpt[1,3]
    ...
    CM36_5 = s.In[9,6]*S6-CM17_5*S7-CM18_5*S8+CM37_5*C7+CM39_5*C8+FB27_5*s.dpt[1,2]+FM28_5*s.dpt[1,3]
    FB16_6 = s.m[6]*s.l[3,6]
    CM26_6 = s.In[5,6]+s.In[5,7]+CM28_6+FB16_6*s.l[3,6]-s.dpt[1,2]*(-FB17_6*S7+FB37_6*C7)-s.dpt[1,3]*(-FM18_6*S8+FM39_6*C8)+s.dpt[3,3]*(FM18_6*C8+FM39_6*S8)
