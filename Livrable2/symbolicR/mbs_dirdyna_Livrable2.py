...
# Forward Kinematics
    ...
    AF110 = C10*(AF19+BEF39*s.dpt[3,6])-S10*(AF38+BS99*s.dpt[3,6])
    AF210 = AF29+BEF69*s.dpt[3,6]
    AF310 = C10*(AF38+BS99*s.dpt[3,6])+S10*(AF19+BEF39*s.dpt[3,6])
    ...
    AM110_4 = -AM38_4*S10+C10*(AM19_4+OB29_4*s.dpt[3,6])
    AM210_4 = AM29_4-OB19_4*s.dpt[3,6]
    AM310_4 = AM38_4*C10+S10*(AM19_4+OB29_4*s.dpt[3,6])
    OB110_5 = OB19_5*C10-S6p8*S10
    OB310_5 = OB19_5*S10+S6p8*C10
    AM110_5 = C10*(AM19_5+OB29_5*s.dpt[3,6])
    AM210_5 = AM29_5-OB19_5*s.dpt[3,6]
    AM310_5 = S10*(AM19_5+OB29_5*s.dpt[3,6])
    OB110_6 = C10*S9
    OB310_6 = S10*S9
    AM110_6 = -AM38_6*S10+C10*(AM19_6+s.dpt[3,6]*C9)
    AM210_6 = AM29_6-s.dpt[3,6]*S9
    AM310_6 = AM38_6*C10+S10*(AM19_6+s.dpt[3,6]*C9)
    OB110_8 = C10*S9
    OB310_8 = S10*S9
    AM110_8 = s.dpt[3,6]*C10*C9
    AM210_8 = -s.dpt[3,6]*S9
    AM310_8 = s.dpt[3,6]*S10*C9
...
# Backward Dynamics
    ...
    CF19 = -s.trq[1,9]+CF110*C10+CF310*S10-FA210*s.dpt[3,6]
    CF29 = -s.trq[2,9]+CF210+s.dpt[3,6]*(FA110*C10+FA310*S10)
    CF39 = -s.trq[3,9]-CF110*S10+CF310*C10
    FM19_1 = FB110_1*C10+FB310_1*S10
    FM39_1 = -FB110_1*S10+FB310_1*C10
    CM19_1 = -FB210_1*s.dpt[3,6]
    CM29_1 = s.dpt[3,6]*(FB110_1*C10+FB310_1*S10)
    FM19_2 = FB110_2*C10+FB310_2*S10
    FM39_2 = -FB110_2*S10+FB310_2*C10
    CM19_2 = -FB210_2*s.dpt[3,6]
    CM29_2 = s.dpt[3,6]*(FB110_2*C10+FB310_2*S10)
    FM19_3 = FB110_3*C10+FB310_3*S10
    FM39_3 = -FB110_3*S10+FB310_3*C10
    CM19_3 = -FB210_3*s.dpt[3,6]
    CM29_3 = s.dpt[3,6]*(FB110_3*C10+FB310_3*S10)
    FM19_4 = FB110_4*C10+FB310_4*S10
    FM39_4 = -FB110_4*S10+FB310_4*C10
    CM19_4 = CM110_4*C10+CM310_4*S10-FB210_4*s.dpt[3,6]
    CM29_4 = CM210_4+s.dpt[3,6]*(FB110_4*C10+FB310_4*S10)
    CM39_4 = -CM110_4*S10+CM310_4*C10
    FM19_5 = FB110_5*C10+FB310_5*S10
    FM39_5 = -FB110_5*S10+FB310_5*C10
    CM19_5 = CM110_5*C10+CM310_5*S10-FB210_5*s.dpt[3,6]
    CM29_5 = CM210_5+s.dpt[3,6]*(FB110_5*C10+FB310_5*S10)
    CM39_5 = -CM110_5*S10+CM310_5*C10
    FM19_6 = FB110_6*C10+FB310_6*S10
    FM39_6 = -FB110_6*S10+FB310_6*C10
    CM19_6 = CM110_6*C10+CM310_6*S10-FB210_6*s.dpt[3,6]
    CM29_6 = CM210_6+s.dpt[3,6]*(FB110_6*C10+FB310_6*S10)
    CM39_6 = -CM110_6*S10+CM310_6*C10
    CM19_8 = CM110_8*C10+CM310_8*S10-FB210_8*s.dpt[3,6]
    CM29_8 = CM210_8+s.dpt[3,6]*(FB110_8*C10+FB310_8*S10)
