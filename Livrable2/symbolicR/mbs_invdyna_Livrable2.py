...
# Backward Dynamics
    ...
    Cq26 = -s.trq[2,6]+Cq27+Cq28+s.In[1,6]*OM16*OM36+s.In[5,6]*OMp26-s.In[9,6]*OM16*OM36+Fs16*s.l[3,6]-Fs36*s.l[1,6]-s.dpt[1,2]*(-Fs17*S7+Fs37*C7)-s.dpt[1,3]*(-Fq18*S8+Fq39*C8)+s.dpt[3,3]*(Fq18*C8+Fq39*S8)
    Cq36 = -s.trq[3,6]-s.In[1,6]*OM16*OM26+s.In[5,6]*OM16*OM26+s.In[9,6]*OMp36-Cq17*S7-Cq18*S8+Cq37*C7+Cq39*C8+Fq28*s.dpt[1,3]+Fs26*s.l[1,6]+Fs27*s.dpt[1,2]
