...
# Forward Kinematics
    ...
    ALPHA213 = ALPHA211+BETA412*s.dpt[1,12]
    ...
    ALPHA117 = C17*(ALPHA116+BETA316*s.dpt[3,16])+S17*(ALPHA216+BETA616*s.dpt[3,16])
    ALPHA217 = C17*(ALPHA216+BETA616*s.dpt[3,16])-S17*(ALPHA116+BETA316*s.dpt[3,16])
    ALPHA317 = ALPHA316+BS916*s.dpt[3,16]
    ...
    ALPHA119 = C19*(ALPHA118+BETA318*s.dpt[3,18])-S19*(ALPHA318+BS918*s.dpt[3,18])
    ALPHA219 = ALPHA217+BETA618*s.dpt[3,18]
    ALPHA319 = C19*(ALPHA318+BS918*s.dpt[3,18])+S19*(ALPHA118+BETA318*s.dpt[3,18])
    ...
    ALPHA120 = C20*(ALPHA119+BETA219*s.dpt[2,19]+BETA319*s.dpt[3,19]+BS119*s.dpt[1,19])-S20*(ALPHA319+BETA719*s.dpt[1,19]+BETA819*s.dpt[2,19]+BS919*s.dpt[3,19])
    ALPHA220 = ALPHA219+BETA419*s.dpt[1,19]+BETA619*s.dpt[3,19]+BS519*s.dpt[2,19]
    ALPHA320 = C20*(ALPHA319+BETA719*s.dpt[1,19]+BETA819*s.dpt[2,19]+BS919*s.dpt[3,19])+S20*(ALPHA119+BETA219*s.dpt[2,19]+BETA319*s.dpt[3,19]+BS119*s.dpt[1,19])
    ...
    ALPHA121 = C21*(ALPHA120+BS120*s.dpt[1,24])-S21*(ALPHA320+BETA720*s.dpt[1,24])
    ALPHA221 = ALPHA220+BETA420*s.dpt[1,24]
    ALPHA321 = C21*(ALPHA320+BETA720*s.dpt[1,24])+S21*(ALPHA120+BS120*s.dpt[1,24])
    ...
    ALPHA122 = C22*(ALPHA119+BETA219*s.dpt[2,20]+BETA319*s.dpt[3,20]+BS119*s.dpt[1,20])-S22*(ALPHA319+BETA719*s.dpt[1,20]+BETA819*s.dpt[2,20]+BS919*s.dpt[3,20])
    ALPHA222 = ALPHA219+BETA419*s.dpt[1,20]+BETA619*s.dpt[3,20]+BS519*s.dpt[2,20]
    ALPHA322 = C22*(ALPHA319+BETA719*s.dpt[1,20]+BETA819*s.dpt[2,20]+BS919*s.dpt[3,20])+S22*(ALPHA119+BETA219*s.dpt[2,20]+BETA319*s.dpt[3,20]+BS119*s.dpt[1,20])
    ...
    ALPHA123 = C23*(ALPHA122+BS122*s.dpt[1,27])-S23*(ALPHA322+BETA722*s.dpt[1,27])
    ALPHA223 = ALPHA222+BETA422*s.dpt[1,27]
    ALPHA323 = C23*(ALPHA322+BETA722*s.dpt[1,27])+S23*(ALPHA122+BS122*s.dpt[1,27])
    BS324 = OM119*OM319
    BS624 = OM219*OM319
    BS924 = -OM119*OM119-OM219*OM219
    BETA324 = BS324+OMp219
    BETA624 = BS624-OMp119
    ALPHA124 = ALPHA119+q[24]*BETA319+(2.0)*qd[24]*OM219+BS119*s.dpt[1,23]
    ALPHA224 = ALPHA219+q[24]*BETA619-(2.0)*qd[24]*OM119+BETA419*s.dpt[1,23]
    ALPHA324 = qdd[24]+ALPHA319+q[24]*BS919+BETA719*s.dpt[1,23]
    BS325 = OM116*OM316
    BS625 = OM216*OM316
    ...
    ALPHA126 = C26*(ALPHA125+BETA325*s.dpt[3,30])-S26*(ALPHA325+BS925*s.dpt[3,30])
    ALPHA226 = ALPHA225+BETA625*s.dpt[3,30]
    ALPHA326 = C26*(ALPHA325+BS925*s.dpt[3,30])+S26*(ALPHA125+BETA325*s.dpt[3,30])
...
# Backward Dynamics
    ...
    Cq125 = -s.trq[1,25]+s.In[1,25]*OMp116-s.In[5,25]*OM216*OM316+s.In[9,25]*OM216*OM316+Cq126*C26+Cq326*S26-Fs225*s.l[3,25]-Fs226*s.dpt[3,30]
    Cq225 = -s.trq[2,25]+Cq226+s.In[1,25]*OM116*OM316+s.In[5,25]*OMp216-s.In[9,25]*OM116*OM316+Fs125*s.l[3,25]+s.dpt[3,30]*(Fs126*C26+Fs326*S26)
    ...
    Cq222 = -s.trq[2,22]+Cq223+s.In[1,22]*OM122*OM322+s.In[5,22]*OMp222-s.In[9,22]*OM122*OM322-Fs322*s.l[1,22]-s.dpt[1,27]*(-Fs123*S23+Fs323*C23)
    Cq322 = -s.trq[3,22]-s.In[1,22]*OM122*OM222+s.In[5,22]*OM122*OM222+s.In[9,22]*OMp322-Cq123*S23+Cq323*C23+Fs222*s.l[1,22]+Fs223*s.dpt[1,27]
    ...
    Cq220 = -s.trq[2,20]+Cq221+s.In[1,20]*OM120*OM320+s.In[5,20]*OMp220-s.In[9,20]*OM120*OM320-Fs320*s.l[1,20]-s.dpt[1,24]*(-Fs121*S21+Fs321*C21)
    Cq320 = -s.trq[3,20]-s.In[1,20]*OM120*OM220+s.In[5,20]*OM120*OM220+s.In[9,20]*OMp320-Cq121*S21+Cq321*C21+Fs220*s.l[1,20]+Fs221*s.dpt[1,24]
    ...
    Cq119 = -s.trq[1,19]+Cq124-q[24]*Fs224+s.In[1,19]*OMp119-s.In[5,19]*OM219*OM319+s.In[9,19]*OM219*OM319+Cq120*C20+Cq122*C22+Cq320*S20+Cq322*S22-Fq220*s.dpt[3,19]-Fq222*s.dpt[3,20]-Fs219*s.l[3,19]+s.dpt[2,19]*(-Fq120*S20+Fq320*C20)+s.dpt[2,20]*(-Fq122*S22+Fq322*C22)
    Cq219 = -s.trq[2,19]+Cq220+Cq222+Cq224+q[24]*Fs124+s.In[1,19]*OM119*OM319+s.In[5,19]*OMp219-s.In[9,19]*OM119*OM319+Fs119*s.l[3,19]-Fs319*s.l[1,19]-Fs324*s.dpt[1,23]-s.dpt[1,19]*(-Fq120*S20+Fq320*C20)-s.dpt[1,20]*(-Fq122*S22+Fq322*C22)+s.dpt[3,19]*(Fq120*C20+Fq320*S20)+s.dpt[3,20]*(Fq122*C22+Fq322*S22)
    Cq319 = -s.trq[3,19]+Cq324-s.In[1,19]*OM119*OM219+s.In[5,19]*OM119*OM219+s.In[9,19]*OMp319-Cq120*S20-Cq122*S22+Cq320*C20+Cq322*C22+Fq220*s.dpt[1,19]+Fq222*s.dpt[1,20]+Fs219*s.l[1,19]+Fs224*s.dpt[1,23]-s.dpt[2,19]*(Fq120*C20+Fq320*S20)-s.dpt[2,20]*(Fq122*C22+Fq322*S22)
    ...
    Cq118 = -s.trq[1,18]+s.In[1,18]*OMp118-s.In[5,18]*OM218*OM318+s.In[9,18]*OM218*OM318+Cq119*C19+Cq319*S19-Fq219*s.dpt[3,18]-Fs218*s.l[3,18]
    Cq218 = -s.trq[2,18]+Cq219+s.In[1,18]*OM118*OM318+s.In[5,18]*OMp218-s.In[9,18]*OM118*OM318+Fs118*s.l[3,18]+s.dpt[3,18]*(Fq119*C19+Fq319*S19)
    ...
    Cq116 = -s.trq[1,16]+Cq125+s.In[1,16]*OMp116-s.In[5,16]*OM216*OM316+s.In[9,16]*OM216*OM316+Cq117*C17-Cq218*S17-Fq225*Dz253-Fs216*s.l[3,16]-s.dpt[3,16]*(Fq117*S17+Fq218*C17)
    Cq216 = -s.trq[2,16]+Cq225+s.In[1,16]*OM116*OM316+s.In[5,16]*OMp216-s.In[9,16]*OM116*OM316+Cq117*S17+Cq218*C17+Fq125*Dz253+Fs116*s.l[3,16]+s.dpt[3,16]*(Fq117*C17-Fq218*S17)
